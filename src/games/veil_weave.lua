...
local CHANNELS = {
    ...
    ["127293443282395"] = { name = "Festering Wound ground punches", range = 45, sword = true,
                            strikes = { 0.96, 1.41 } },
    -- Festering Wound rot pillar 111237192632620: a 14x96 column on your spot ticking 10.5
    -- dmg every ~0.1 s (0.15-0.93 s, again 2.0-2.8 s) -> dash sideways out of it at once
    ["111237192632620"] = { name = "Festering Wound rot pillar", range = 60, dir = "Sideways" },
}
